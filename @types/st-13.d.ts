...
module BoxLayout {
    ...
    interface ConstructorProperties extends Scrollable.ConstructorProperties, Viewport.ConstructorProperties {
...
interface BoxLayout extends Scrollable {
...
interface TextureCache {
     ...
     * @returns A new #GIcon
     */
    load_cairo_surface_to_gicon(surface: any): Gio.Icon
    /**
     ...
     */
    load_file_to_cairo_surface(file: Gio.File, paint_scale: number, resource_scale: number): any
    /**
...
module Viewport {
    ...
    interface ConstructorProperties extends Scrollable.ConstructorProperties, Widget.ConstructorProperties {
...
interface Viewport extends Scrollable {
...
interface Widget {
     ...
     */
    add_accessible_state(state: any): void
    /**
     ...
     */
    remove_accessible_state(state: any): void
    /**
     ...
     */
    set_accessible(accessible: any): void
    /**
     ...
     */
    set_accessible_role(role: any): void
    /**
