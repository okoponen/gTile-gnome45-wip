...
class Pixbuf extends GObject.Object {
     ...
     * @returns A newly-created pixbuf
     */
    static newFromData(data: number[], colorspace: Colorspace, hasAlpha: boolean, bitsPerSample: number, width: number, height: number, rowstride: number, destroyFn: PixbufDestroyNotify | null): Pixbuf
    /**
...
interface PixbufLoader {
    ...
    on(sigName: "area-prepared", callback: PixbufLoader.AreaPreparedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "area-prepared", callback: PixbufLoader.AreaPreparedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "area-prepared", callback: PixbufLoader.AreaPreparedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "area-updated", callback: PixbufLoader.AreaUpdatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "area-updated", callback: PixbufLoader.AreaUpdatedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "area-updated", callback: PixbufLoader.AreaUpdatedSignalCallback): NodeJS.EventEmitter
    ...
    on(sigName: "closed", callback: PixbufLoader.ClosedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "closed", callback: PixbufLoader.ClosedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "closed", callback: PixbufLoader.ClosedSignalCallback): NodeJS.EventEmitter
    emit(sigName: "closed", ...args: any[]): void
    connect(sigName: "size-prepared", callback: PixbufLoader.SizePreparedSignalCallback): number
    on(sigName: "size-prepared", callback: PixbufLoader.SizePreparedSignalCallback, after?: boolean): NodeJS.EventEmitter
    once(sigName: "size-prepared", callback: PixbufLoader.SizePreparedSignalCallback, after?: boolean): NodeJS.EventEmitter
    off(sigName: "size-prepared", callback: PixbufLoader.SizePreparedSignalCallback): NodeJS.EventEmitter
